...
# Script Copyright ComfortVPS. Edited by EXAtrueCloud
...
wget -O /etc/nginx/nginx.conf https://raw.github.com/EXAtrueCloud/Nginx-PHP-MySql-phpMyAdmin/master/nginx-main-conf.txt;

wget -O /etc/nginx/conf.d/default.conf  https://raw.github.com/EXAtrueCloud/Nginx-PHP-MySql-phpMyAdmin/master/nginx-default-conf.txt;

wget -O /etc/nginx/conf.d/example.com.conf  https://raw.github.com/EXAtrueCloud/Nginx-PHP-MySql-phpMyAdmin/master/nginx-custom-config-example.txt;

wget -O /etc/nginx/conf.d/my_domain https://raw.github.com/EXAtrueCloud/Nginx-PHP-MySql-phpMyAdmin/master/nginx-my-domain-conf.txt;
...
if [ `echo "$FREE_RAM < 512"|bc` -eq 1 ]
then
	mv /etc/my.cnf /etc/my.cnf.bak;
	wget -O /etc/my.cnf https://raw.github.com/EXAtrueCloud/Nginx-PHP-MySql-phpMyAdmin/master/mysql-my-cnf.txt;
...
wget -O /www/ip.com/index.php  https://raw.github.com/EXAtrueCloud/Nginx-PHP-MySql-phpMyAdmin/master/nginx-default-index.html;


wget -O /www/mysql-and-sftp-password.php  https://raw.github.com/EXAtrueCloud/Nginx-PHP-MySql-phpMyAdmin/master/nginx-mysql-password.html;
...
wget -O /www/ip.com/custom_error_page/404.html  https://raw.github.com/EXAtrueCloud/Nginx-PHP-MySql-phpMyAdmin/master/nginx-404.html;
wget -O /www/ip.com/custom_error_page/403.html  https://raw.github.com/EXAtrueCloud/Nginx-PHP-MySql-phpMyAdmin/master/nginx-403.html;
wget -O /www/ip.com/custom_error_page/50x.html  https://raw.github.com/EXAtrueCloud/Nginx-PHP-MySql-phpMyAdmin/master/nginx-50x.html;
...
wget -O /www/ip.com/phpmyadmin_url.txt  https://raw.github.com/EXAtrueCloud/Nginx-PHP-MySql-phpMyAdmin/master/phpmyadmin_url.txt
...
echo "====== phpMyAdmin: http://`hostname -i`/phpMyAdmin/";
echo "====== OR: http://your-ip-address/phpMyAdmin/";
echo -e "\n\n\n";
